...
// size of offloading hashtable (max num entries)
#define OFFLOAD_TABLE_SIZE ((1 << 21) - 1)
...
// enable or disable collection and transmission of custom offload stats
// packets
/* #define ENABLE_OFFLOAD_STATS */
